...
if (isset($_POST['save'])){
    ...
    $profile_lama = $_POST['gambar_profile'];
        ...
        if (!$fileName == "") {
            ...
            $sql = mysqli_query($db, "UPDATE profile SET profile_title='$title',profile_history='$sejarah',profile_visi='$visi',profile_logo='$fileName',profile_location='$path',profile_address='$alamat' WHERE id='$idprofile'");
            ...
            $sql = mysqli_query($db, "UPDATE profile SET profile_title='$title',profile_history='$sejarah',profile_visi='$visi',profile_logo='$profile_lama',profile_location='$path',profile_address='$alamat' WHERE id='$idprofile'");
            header('Location: ../../public/cms/profile_sekolah/');
            session_start();
            $_SESSION['edit_message'] = "Data Berhasil Diganti !";
            header('Location: ../../public/cms/profile_sekolah/');
