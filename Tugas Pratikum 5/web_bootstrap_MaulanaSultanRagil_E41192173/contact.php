         ...
         <div class="col-x1-12 col-lg-7">
          <div class="card shadow mb-4">
            ...
            <div class="dropdown no-arrow">
              <a class="dropdown-toggle" href="#" rp;e="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="card-body">
              <form>
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="subject" name="subject" placeholder="Subjek Pesan Anda" require>
                </div>
                <div class="form-group">
