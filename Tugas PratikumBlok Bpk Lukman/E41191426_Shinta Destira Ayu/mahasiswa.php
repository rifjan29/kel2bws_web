...
<?php include "./sidebar.php" ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        ...
        <tr height="46">
            <td> </td>
            <td>NIM</td>
            <td><input type="text" name="nim" size="35" maxlength="9" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>Nama</td>
        ...
        <tr height="46">
            <td> </td>
            <td>Password</td>
            <td><input type="password" name="password" size="20" maxlength="12" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td> </td>
    ...
    <?php
        ...
        $mysqli = "INSERT INTO tb_mahasiswa (nim,nama,tgl_lahir,agama,email,username,pass) VALUES ('$nim','$nama','$tgl_lahir','$agama','$email','$username','$password')";
