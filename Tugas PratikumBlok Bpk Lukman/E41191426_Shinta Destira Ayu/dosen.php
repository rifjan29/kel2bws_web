    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="container-fluid">
        ...
        <tr height="46">
            <td> </td>
            <td>NIDSN</td>
            <td><input type="text" name="nidsn" size="35" maxlength="9" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>Nama</td>
        ...
        <tr height="46">
            <td> </td>
            <td>Tanggal Lahir</td>
            <td><input type="date" name="tgl_lahir" size="50" maxlength="30" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td>Agama</td>
        ...
        <tr height="46">
            <td> </td>
            <td>No Telepon</td>
            <td><input type="text" name="no_telepon" size="50" maxlength="12" /></td>
        </tr>
        <tr height="46">
            <td> </td>
            <td> </td>
            <td><button type="submit" name="submit" class="btn btn-success">Tambah</button>  
                
        </tr>
    </table>
    <?php
        include "konek.php";
        $nidsn = @$_REQUEST['nidsn'];
        $nama = @$_REQUEST['nama']; 
        $tgl_lahir = @$_REQUEST['tgl_lahir'];
        $agama = @$_REQUEST['agama'];
        $alamat = @$_REQUEST['alamat'];
        $no_telepon = @$_REQUEST['no_telepon'];
        $mysqli = "INSERT INTO tb_dosen (nidsn,nama,tgl_lahir,agama,alamat,no_telepon) VALUES ('$nidsn','$nama','$tgl_lahir','$agama','$alamat','$no_telepon')";
