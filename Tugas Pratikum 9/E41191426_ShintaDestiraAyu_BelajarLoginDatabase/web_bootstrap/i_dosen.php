      ...
      <div class="container-fluid">
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Form Dosen</h2>
                    <form action= "" method="POST">
                        <div class="row row-space">
                            <div class="col-12">
                                <div class="input-group">
                                    <label class="label">NIDSN</label>
                                    <input class="input--style-4" type="text" name="nidsn" onkeypress="return onlyAlphabets(event,this);" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group">
